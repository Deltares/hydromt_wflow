...
.. list-table::
    ...
    * - :py:func:`~WflowBaseModel.setup_reservoirs_simple_control`
    ...
    * - :py:func:`~WflowBaseModel.setup_glaciers`
    ...
    * - :py:func:`~WflowBaseModel.setup_lulcmaps`
...
The following table provides an overview of which :py:class:`~hydromt_wflow.WflowBaseModel`
components contains which Wflow in- and output files. The files are read and written with the associated
read- and write- methods, i.e. :py:func:`~WflowBaseModel.read_config`
and :py:func:`~WflowBaseModel.write_config` for the
:py:attr:`~WflowBaseModel.config` component.
...
.. list-table:: Wflow model data
   ...
   * - :py:class:`~hydromt_wflow.WflowBaseModel` model
     - Wflow files
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.config`
     - wflow_sbm.toml
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.staticmaps`
     - staticmaps.nc
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.geoms`
     - geometries from the staticgeoms folder (basins.geojson, rivers.geojson etc.)
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.forcing`
     - inmaps.nc
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.states`
     - instates.nc
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.tables`
     - tabular data (csv format, e.g. lake_hq.csv, lake_sh.csv)
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.output_grid`
     - output.nc (defined in [output.netcdf_grid] TOML section)
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.output_scalar`
     - output_scalar.nc (defined in [output.netcdf_scalar] TOML section)
   * - :py:attr:`~hydromt_wflow.WflowBaseModel.output_csv`
