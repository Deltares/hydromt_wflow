...
:download:`.ini file <../examples/examples/wflow_sediment_build.ini>`. Each section corresponds 
to a model component with the same name.

.. literalinclude:: ../examples/examples/wflow_sediment_build.ini
   :language: Ini
...
These components are available in a template :download:`.ini file <../examples/examples/wflow_extend_sediment.ini>` and shown below. The corresponding 
...
.. literalinclude:: ../examples/examples/wflow_extend_sediment.ini
   :language: Ini
