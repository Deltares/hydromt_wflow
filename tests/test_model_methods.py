...
def test_setup_rootzoneclim():
    ...
    assert mod.staticgeoms["rootzone_storage"].loc[1]["rootzone_storage_cc_hist_2"] == pytest.approx(70.26993058321949, abs=0.5)
    assert mod.staticgeoms["rootzone_storage"].loc[1]["rootzone_storage_cc_fut_2"] == pytest.approx(80.89081789601374, abs=0.5)
    ...
    assert mod.staticgeoms["rootzone_storage"].loc[1]["rootzone_storage_obs_2"] == pytest.approx(82.85684577620462, abs=0.5)
    assert mod.staticgeoms["rootzone_storage"].loc[1]["rootzone_storage_cc_hist_2"] == pytest.approx(82.44039441508069, abs=0.5)
    assert mod.staticgeoms["rootzone_storage"].loc[1]["rootzone_storage_cc_fut_2"] == pytest.approx(104.96931418911882, abs=0.5)
