...
create(DslContext.projectId, BuildType({
    ...
    params {
        ...
        text("wflow.cli.branch.filter", "+:tags/%wflow.latest.release%", description = "Newline-delimited set of rules in the form of +|-:logical branch name (with an optional * placeholder)", allowEmpty = false)
    }
